CREATE OR REPLACE TABLE SUMUP.CLEAN.CASES (
    ...
    ACTUAL_ESCALATED_AT    TIMESTAMP_NTZ(9), -- Original escalation TIMESTAMP_NTZ(9) of the case
    ADJUSTED_ESCALATED_AT  TIMESTAMP_NTZ(9), -- Escalation TIMESTAMP_NTZ(9) adjusted according to business rules
    ...
    FRT_AT                 TIMESTAMP_NTZ(9), -- TIMESTAMP_NTZ(9) of the first response to the case
    ...
    ELT_INSERT_TIMESTAMP   TIMESTAMP_NTZ(9) -- When the row was inserted
)
